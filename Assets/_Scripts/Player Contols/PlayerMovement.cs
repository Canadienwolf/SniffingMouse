...
{
    public Transform cam_trans;             //The transform of the camera in use
    public test_GroundCheck groundCheck;    // A child object with a collider checking if the player is on the ground
    public PlayerStatesMovements playerStates;      //A scriptable object containing the movement states of the player
    ...
    [Range(10, 30)]
    public float fallingSpeedMultiplier = 25;
    [Range(0, 15)]
